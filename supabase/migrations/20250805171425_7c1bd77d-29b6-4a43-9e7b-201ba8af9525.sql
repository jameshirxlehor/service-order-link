-- Remove foreign key constraint that's blocking sample data
ALTER TABLE public.user_profiles DROP CONSTRAINT IF EXISTS user_profiles_auth_id_fkey;

-- Make auth_id nullable for sample data
ALTER TABLE public.user_profiles ALTER COLUMN auth_id DROP NOT NULL;
...
DROP POLICY IF EXISTS "City halls can view their own profile" ON public.city_halls;
